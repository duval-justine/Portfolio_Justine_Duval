<template>
  <main>
    <div class="snap">
      <!-- Accueil -->
      <section>
        <div class="container0 h-screen z-0 bg-gradient-to-b from-pastelbleu to-pastelrose scroll-snap ">
          <!-- Header -->
          ...
          <div class="flex flex-col items-center  gap-4">
            <RouterLink
              class="font-space-grotesk font-bold text-sm absolute bottom-6 text-Extended/red/50 lg:text-lg lg:" to="/">
              SCROLL
            </RouterLink>
